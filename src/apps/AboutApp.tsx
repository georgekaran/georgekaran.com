  ...
  return (
    <div className="p-6 space-y-6 text-[color:var(--os-text)]">
      ...
      <p className="leading-relaxed">
        A Software Engineer with {years}+ years of experience in the SaaS industry with strong fundamentals in React,
        TypeScript and Node.
      </p>
      <p className="leading-relaxed text-[color:var(--os-text-muted)]">
        I regularly attend web development meetups and contribute to open-source projects (currently a maintainer of
        Ariakit), staying connected with the community and keeping my skills sharp. My expertise spans modern frontend —
        React, JavaScript, TypeScript, GraphQL, and testing — with a focus on accessible, performant apps and great
