const GROUPS = [
  ...
  {
    title: 'Backend',
    items: ['Node.js', 'SQL', 'Postgres', 'MongoDB', 'Java', 'Spring', 'Go', 'Full-Stack', 'Webpack', 'CI/CD'],
  },
  {
  ...
  return (
    <div className="p-6 grid sm:grid-cols-2 gap-4 text-[color:var(--os-text)]">
      {GROUPS.map((g) => (
        <div
          key={g.title}
          className="rounded-xl border border-[color:var(--os-border)] bg-[color:var(--os-surface)] p-4"
        >
